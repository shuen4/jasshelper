...
type
  TMain = class(TForm)
    ...
    procedure PrintParseTree(Text: RawByteString);
  ...
  private
    SL : TStringList;
    procedure AddToReport(Msg1, Msg2, Msg3, Msg4 : RawByteString; LN : integer);
...
procedure TMain.PrintParseTree(Text: RawByteString);
begin
...
procedure TMain.AddToReport(Msg1, Msg2, Msg3, Msg4: RawByteString; LN: integer);
begin
